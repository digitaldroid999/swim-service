...
/**
 * Extract XML/text body from Solace SMF message. Tries TEXT SDT, then binary attachment,
 * then SDT again (some brokers mark payload BINARY but still expose SDT).
 */
function messageBodyToString(message) {
  ...
  // Prefer longest non-empty segment (full XML vs duplicate fragments)
